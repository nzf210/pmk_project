#ifndef PDF_SPPD_ALL_CAIR_H
#define PDF_SPPD_ALL_CAIR_H
...
public:
        ...
        QWidget(parent),  button2(new QPushButton),button(new QPushButton),progressbar(new QProgressBar),  progressbar2(new QProgressBar), view(new QWebEngineView), view2(new QWebEngineView)
    {
        ...
        button->setText(tr("generate pdf gab realisasi"));
        button->setEnabled(false);

        connect(button, &QPushButton::clicked, this, &Widget7::onClicked);
        connect(view, &QWebEngineView::loadFinished, this, &Widget7::onLoadFinished);
        connect(view->page(), &QWebEnginePage::pdfPrintingFinished, this, &Widget7::onPdfPrintingFinished);
...
//               qInfo() <<"Jumlah Cair dari form" <<  fr->getTot_sppd();
               ...
               if(fOut.open(QFile::WriteOnly | QFile::Text)){qInfo()<<"tdk Bisa Buka file pengantar gabungan.html";} else {
...
//            }
           ...
           void onClicked()
           {
               ...
               QString de = d.toString("dd_MM_yyyy_mm_ss");
               //QDate dd = QLocale{QLocale::Indonesian}.toDateTime(d,"dd-MM-yyyy mm:ss");



               QString path("laporan/sppd/");
               QDir dir(path);
               QFile  pdfFile (path+" "+nm_kam_+" "+nm_dis_+" "+tgl_+ " SPP_all "+de+".pdf");
               QString fn =    path+" "+nm_kam_+" "+nm_dis_+" "+tgl_+" SPP_all "+de+".pdf";
               ...
               view->page()->printToPdf(fn,QPageLayout(QPageSize(QPageSize(QSize(780,1154))), QPageLayout::Landscape, QMargins(50,10,10,15))); // fix sppd
           ...
           void run() {
                   ...
                   timer->connect(timer, &QTimer::timeout, this, &Widget7::klik_buton);
                   timer->start();
               }
