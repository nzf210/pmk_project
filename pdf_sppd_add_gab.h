#ifndef PDF_SPPD_ADD_GAB_H
#define PDF_SPPD_ADD_GAB_H
...
public:
        ...
        QWidget(parent),  button2(new QPushButton),button(new QPushButton),progressbar(new QProgressBar),  progressbar2(new QProgressBar), view(new QWebEngineView), view2(new QWebEngineView)
    {
        ...
        connect(button, &QPushButton::clicked, this, &Widget8::onClicked);
        connect(view, &QWebEngineView::loadFinished, this, &Widget8::onLoadFinished);
        connect(view->page(), &QWebEnginePage::pdfPrintingFinished, this, &Widget8::onPdfPrintingFinished);
...
//            }
           ...
           void run() {
                   ...
                   timer->connect(timer, &QTimer::timeout, this, &Widget8::klik_buton);
                   timer->start();
               }
