...
public:
 ...
 QMessageBox *msgBox;
        ...
        QWidget(parent),  button2(new QPushButton),button(new QPushButton),progressbar(new QProgressBar),  progressbar2(new QProgressBar), view(new QWebEngineView), view2(new QWebEngineView)
    {
        ...
        connect(view, &QWebEngineView::loadFinished, this, &Widget6::onLoadFinished);
        connect(view->page(), &QWebEnginePage::pdfPrintingFinished, this, &Widget6::onPdfPrintingFinished);

        //connect(button, &QPushButton::clicked, this, &Widget::onClicked2);
        connect(view2, &QWebEngineView::loadFinished, this, &Widget6::onLoadFinished2);
        connect(view2->page(), &QWebEnginePage::pdfPrintingFinished, this, &Widget6::onPdfPrintingFinished2);
...
//!=================================================================================
        ...
        QDir dir(path);
        QFile  htmlFile (path+ "blt_srt_1.html");
       ...
       htmlContent.replace("#JBTKPDNS#", jbt_klp_dns);
        ...
        QFile  htmlFile2 (path+ "blt_srt_2.html");
        ...
        QUrl url = QUrl::fromLocalFile("/doc/temp/blt1.html");
        view->setHtml(html);
        view->load(url);

        QUrl url2 = QUrl::fromLocalFile("/doc/temp/blt2.html");
        view2->setHtml(html2);
        view2->load(url2);
...
//private:
    ...
    void onClicked()
    {
        ...
        msgBox->setText("Open File pdf BLT ... ");
    ...
    {
        QString pt("doc/temp/");
        QFile  dtpdf1 (pt+ "dtpdf_blt1.txt");
       if (!dtpdf1.open(QIODevice::ReadOnly | QIODevice::Text))
       {
          qInfo() << "dtpdf_blt1.txt File tdk terbuka";
          return;
       }
